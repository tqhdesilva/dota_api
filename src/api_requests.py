...
def get_match_history(game_mode, start_at_match_id, key=key):
    url = 'http://api.steampowered.com/IDOTA2Match_570/GetMatchHistory/v001?game_mode={game_mode}&start_at_match_id={start_at_match_id}&key={key}'\ # noqa #
